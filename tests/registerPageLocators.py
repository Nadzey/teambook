...
class RegisterPageLocators:
    ...
    SKIP_P = (By.CSS_SELECTOR, 'body > div.MuiDialog-root.register-pop-up__container.MuiModal-root.css-126xj0f > div.MuiDialog-container.MuiDialog-scrollPaper.css-ekeie0 > div > div.MuiDialogActions-root.MuiDialogActions-spacing > button')
